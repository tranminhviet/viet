...
<!--menu-->
	...
	<!--welcome-->
		<div class="welcome_index">
			Xin Lỗi , Chức năng hiện đang được bảo trì. Hãy quay về Menu chính.
...
<!--
			<br><br><center><h3>Please Select Your Preferred launguage</h3></center>
...
<center>
			 ...
			 <a href="spamcommenter.php"class="btn btn-danger" >Spam Commenter</a>
			 <hr>
...
<script>
	$(document).ready(function () {
		...
		$('.followSelector').socialProfiles({
			animation: 'chain',
			blur: true,
			facebook: 'sharer/sharer.php?u=https://www.tipsvstricks.com/',
			google: 'share?url=https://www.tipsvstricks.com/',
			twitter: 'share?url=https://www.tipsvstricks.com/',
		});
	});
</script>
